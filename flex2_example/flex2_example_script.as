...
var gatewayURL:String = "http://localhost:8080/flex2_example/gateway";

public function calculateResult(result:String) {
    sum.text = result;
}

public function calculate2Result(result:Object) {
