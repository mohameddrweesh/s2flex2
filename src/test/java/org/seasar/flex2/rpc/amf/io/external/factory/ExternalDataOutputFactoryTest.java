...
public class ExternalDataOutputFactoryTest extends S2TestCase {
    ...
    public void testCreateDataOutput() throws Exception {
        S2Container container = getContainer();
        DataOutputFactory factory = (DataOutputFactory)container.getComponent(DataOutputFactory.class);
        DataOutput output = factory.createDataOutput(new DataOutputStream(System.out));
