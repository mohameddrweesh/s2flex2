...
/**
 * AMFのメッセージクラスです。<br>
 * <p>Flex(Flash)クライアントから送信されたバイナリフォーマットを読み込み、S2Flex2側でデータを扱うときにこのメッセージクラスを利用します。</p>
 * @author e1.arkw
 * @author nod
 *
 */
public class Message {
    ...
    private int version;
    /**
     * コンストラクタ。Messageクラスを構築します。<br/>
     * 各プロパティの初期化を行います。versionはAMF3を示す値をセットします。
     *
     */
    public Message() {
     ...
     * @param header 追加するMessageHeader
     */
