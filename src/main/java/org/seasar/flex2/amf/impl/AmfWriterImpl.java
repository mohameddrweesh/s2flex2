...
import org.seasar.flex2.amf.AmfConstants;
import org.seasar.flex2.amf.AmfDataType;
import org.seasar.flex2.amf.AmfMessage;
import org.seasar.flex2.amf.AmfWriter;
...
public class AmfWriterImpl implements AmfWriter {
	...
	private ArrayList sharedObjects;
	...
	public final void writeObject(Map value) throws IOException {
		int index = getSharedIndex(value);
		if (index >= 0) {
			writeFlashedSharedObject(index);
			return;
	...
	protected void addSharedObject(Object o) {
		sharedObjects.add(o);
	}
